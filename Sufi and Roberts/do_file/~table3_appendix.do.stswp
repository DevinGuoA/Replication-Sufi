...
clear all
set more off
use "${root}/prepared_data/sufi_and_roberts(2009)_appendix.dta"
xtset gvkey time
...
esttab fixed1 fixed2 fixed3 fixed4 using "${root}/output/table3_appendix.tex", replace ///
...
file open table3 using "${root}/output/table3_appendix.tex", write append
...
esttab d1 d2 d3 d4 using "${root}/output/table3_appendix.tex", append ///
